...
export default function AgencyPage() {
  ...
  return (
    <>
      ...
      {/* Stats bar */}
      <div className="border-y border-white/[0.05]  relative z-10">
      ...
      {/* Process */}
      <section className="py-20 px-4  border-y border-white/[0.05] relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-px bg-white/[0.04] rounded-2xl overflow-hidden border border-white/[0.05]">
            {processSteps.map((p, i) => (
              <motion.div key={p.step}
                ...
                viewport={{ once: true, amount: 0 }} transition={{ delay: i * 0.1 }}
                className=" p-7 hover:bg-[#141416] transition-colors">
      ...
      {/* Contact */}
      <section id="contact" className="py-20 px-4  border-t border-white/[0.05] relative z-10">
