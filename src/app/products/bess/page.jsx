...
export default function BESSPage() {
  return (
    <div className="min-h-screen bg-[#0B0B0C] text-white overflow-x-hidden">
      ...
      {/* Hero */}
      <section className="section-hero relative pt-32 pb-16 px-4 overflow-hidden">
      ...
      {/* Features */}
      <section className="section-mid py-12 px-4 border-y border-white/[0.05]">
      ...
      {/* Calculator */}
      <section id="calculator" className="section-dark py-20 px-4">
      ...
      {/* CTA */}
      <section className="section-mid py-16 px-4 border-t border-white/[0.05]">
